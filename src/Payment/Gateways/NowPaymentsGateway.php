...
class NowPaymentsGateway implements PaymentGatewayInterface
{
    ...
    {
        return 'Pay with cryptocurrency using NowPayments';
    }
    ...
    public function createPayment(array $paymentData): array
    {
        ...
        $cryptoAmount = $this->convertToCrypto($paymentData['amount'], $paymentData['currency'], $cryptoCurrency, $exchangeRates);
        ...
        $requestData = [
            ...
            'order_description' => $paymentData['description'] ?? 'Payment',
            'ipn_callback_url' => $paymentData['callback_url'],
    ...
    {
        $response = $this->makeApiRequest('GET', "/payment/{$transactionId}");
    ...
    {
        // NowPayments doesn't support payment cancellation
        // Payments expire automatically
        return false;
    }
    ...
    {
        try {
            $response = $this->makeApiRequest('GET', '/status');
